Namespace CARO 'Computer Antivirus Research Organization
    ...
    Public Class VirNames
        ...
        Public Shared Function Generate(ByVal TypeA As Type, ByVal PlatformsA As Platforms,
                                              ByVal FamilyA As Family, ByVal VariantA As VariantL, ByVal SuffixesA As Suffixes,
