...
#Region " Properties "
        ...
        Private ReadOnly ExtensionsColllection As New List(Of ChromeExtension)
        Public ReadOnly Property Extensions As List(Of ChromeExtension)
            <DebuggerStepThrough>
            Get
...
#Region " Declare's "
        ...
        Public Shared ReadOnly ExtensionsPath = IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "AppData\Local\Google\Chrome\User Data\Default\Extensions\")
...
#End Region
        ...
        Public Sub New(Optional ByVal ProcMethod As ProcesorMethod = ProcesorMethod.Sync)
            ...
            For Each ExFolder As String In ExtensionsFolders
                ...
                Dim ChoEx As New ChromeExtension(ExFolder, ProcMethod)
...
#End Region
        ...
        Public NotInheritable Class ChromeExtension
...
#End Region
        ...
        Public Class ChromeScanner
            ...
            Public Function IsSuspiciusExtension(ByVal GExtensions As ChromeExtension) As Boolean
